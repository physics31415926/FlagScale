...
from flagscale.agent.react.judge import Judge, JudgeBudget, _CLASSIFY_PROMPTS
...
class TestClassifyPrompts:
    EXPECTED_CATEGORIES = {
        ...
        "checklist_rule_batch", "extract_constraints", "route_intent",
        "is_frozen_excuse", "is_constraint_violated", "skill_suggest",
    }
