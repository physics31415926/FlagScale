...
_guard_spec = importlib.util.spec_from_file_location(
    "guard", pathlib.Path(__file__).parent.parent / "guard" / "__init__.py"
)
...
sys.modules["flagscale.agent.react.state_machine"] = _sm
...
class TestGuardContextToolEffects:
    ...
    def test_effects_from_tool(self):
        from flagscale.agent.react.tools.base import ToolEffect, EFFECT_SHELL
        ctx = GuardContext(
            tool_name="shell",
    ...
    def test_guard_can_use_effects_for_decision(self):
        ...
        from flagscale.agent.react.tools.base import ToolEffect, EFFECT_WRITE_FS
        ...
        # Read tool → allowed
        from flagscale.agent.react.tools.base import EFFECT_READ_FS
