...
class TestAnthropicProvider:
    @pytest.fixture
    def provider(self):
        with patch("flagscale.agent.react.providers.anthropic_provider.anthropic") as mock_mod:
            mock_client = MagicMock()
            mock_mod.Anthropic.return_value = mock_client
            from flagscale.agent.react.providers.anthropic_provider import AnthropicProvider
...
class TestOpenAIProvider:
    @pytest.fixture
    def provider(self):
        with patch("flagscale.agent.react.providers.openai_provider.OpenAI") as mock_cls:
            mock_client = MagicMock()
